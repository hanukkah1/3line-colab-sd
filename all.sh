...
function run {
    ...
    cd $BASEPATH && python launch.py --listen --share --xformers --opt-sdp-attention --disable-safe-unpickle --theme dark --enable-insecure-extension-access --no-hashing --no-half-vae --clip-models-path $BASEPATH/models/CLIP
}
