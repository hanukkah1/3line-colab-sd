...
function run {
    ...
    cd $BASEPATH && python launch.py --xformers --opt-sdp-attention --disable-safe-unpickle --theme dark --enable-insecure-extension-access --no-hashing --no-half-vae --no-half --clip-models-path $BASEPATH/models/CLIP
}
